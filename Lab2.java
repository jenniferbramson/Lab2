public class Lab2 {
    ...
    public static void main(String[] args) {
        ...
        short numSacksPerWife = 7;
        
        short numCatsPerSack = 7;
        
        short numKitsPerCat = 7;
        ...
        if (manGoingToStIves) {
            ...
            int totalSacks = numWives * numSacksPerWife;
            int totalCats = totalSacks * numCatsPerSack;
            int totalKitts = totalCats * numKitsPerCat;
            
            total = 2 + numWives + totalCats + totalKitts; //Sacks are not alive, so not included
